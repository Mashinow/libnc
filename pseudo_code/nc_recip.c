...
// ======================================================
// Function: nc_recip @ 0x66A208C0
// ======================================================

_QWORD *__fastcall nc_recip(__int64 a1)
{
  __int64 v1; // rdi
  _QWORD *v3; // rax
  int v4; // r15d
  ...
  while ( v9 != -1 )
  {
    ...
    if ( v11 > 0 )
    {
      ...
      if ( v11 != 1 )
      {
        v13 += *(_QWORD *)(a1 + 96) * v34;
        if ( v11 != 2 )
        {
          v13 += *(_QWORD *)(a1 + 104) * v35;
          if ( v11 != 3 )
          {
            v14 = v36;
            v15 = *(_QWORD *)(a1 + 112);
...
LABEL_44:
    ...
    (*(void (__fastcall **)(__int64, __int64, __int64, __int64))(v1 + 200))(v1, v14 + v9, v13, v6);
    v17 = *(_DWORD *)(a1 + 80);
    if ( v4 >= v17 )
      goto LABEL_39;
    v18 = *v10 + 1;
