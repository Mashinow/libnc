...
// Root function: nc_get_scalar_f32
// Included functions: 3

// ======================================================
// Function: nc_get_scalar_f32 @ 0x66A1A2E0
// ======================================================

__m128 __fastcall nc_get_scalar_f32(__int64 a1)
{
  __int64 v1; // rsi
  int v3; // edx
  void (__fastcall *v4)(__int64, int *, __int64, __int64); // r10
  __int64 v5; // r8
  __int64 v6; // rax
  __m128 result; // xmm0
  int v8[7]; // [rsp+2Ch] [rbp-1Ch] BYREF
  ...
  {
    v4 = *(void (__fastcall **)(__int64, int *, __int64, __int64))(v1 + 96);
    v5 = *(_QWORD *)(a1 + 56);
    goto LABEL_12;
  }
...
LABEL_12:
  ...
  v6 = MEMORY[0] * *(_QWORD *)(a1 + 88);
  if ( v3 != 1 )
  {
    v6 += MEMORY[8] * *(_QWORD *)(a1 + 96);
    if ( v3 != 2 )
    {
      v6 += *(_QWORD *)(a1 + 104) * MEMORY[0x10];
      if ( v3 != 3 )
        v6 += *(_QWORD *)(a1 + 112) * MEMORY[0x18];
    }
  }
LABEL_8:
  v4(v1, v8, v6 + v5, 4i64);
