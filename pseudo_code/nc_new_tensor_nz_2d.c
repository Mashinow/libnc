...
// ======================================================
// Function: nc_new_tensor_nz_2d @ 0x66A14910
// ======================================================

_QWORD *__fastcall nc_new_tensor_nz_2d(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r12
  __int64 v5; // rsi
  _QWORD *v9; // rbx
  ...
  *((_DWORD *)v9 + 20) = 2;
  ...
  v14[4] = 1;
  *((_QWORD *)v14 + 3) = a1;
  v15 = (*(__int64 (__fastcall **)(__int64, _DWORD *, __int64))(a1 + 48))(a1, v14 + 10, v12);
  *((_QWORD *)v14 + 4) = v15;
  if ( !v15 )
