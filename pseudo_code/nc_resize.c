...
// ======================================================
// Function: nc_resize @ 0x66A247E0
// ======================================================

__int64 __fastcall nc_resize(__int64 a1, __int64 a2)
{
  __int64 v3; // r9
  ...
  if ( *(int *)(a1 + 80) <= 0 )
  {
    sub_66A33D40("x->n_dims >= 1", "libnc.c", 6470);
    v3 = a2;
  }
  return nc_pad(a1, 0i64, 0, v3 - *(_QWORD *)(a1 + 120), 0);
}
