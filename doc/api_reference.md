...
- [6.1 Profiling and low-level memory](#61-profiling-and-low-level-memory)
- [6.2 Context, devices, buffers](#62-context-devices-buffers)
- [6.3 Tensor creation and inspection](#63-tensor-creation-and-inspection)
- [6.4 Data access and mutation](#64-data-access-and-mutation)
- [6.5 Element-wise operations](#65-element-wise-operations)
- [6.6 Shape, layout, slicing, and concatenation](#66-shape-layout-slicing-and-concatenation)
- [6.7 Matrix, indexed, and normalization ops](#67-matrix-indexed-and-normalization-ops)
- [6.8 Graph and automatic differentiation](#68-graph-and-automatic-differentiation)
- [6.9 Parameters and serialized state](#69-parameters-and-serialized-state)
- [6.10 SGD optimizer](#610-sgd-optimizer)
- [6.11 Miscellaneous utilities](#611-miscellaneous-utilities)
- [7. Common usage examples](#7-common-usage-examples)
