...
// Root function: nc_log
// Included functions: 2

// ======================================================
// Function: nc_log @ 0x1EC90
// ======================================================

__int64 __fastcall nc_log(_QWORD *ptr)
{
  __int64 v2; // rsi
  __int64 v3; // rax
  int v4; // ebp
...
LABEL_45:
    ...
    (*(void (__fastcall **)(__int64, __int64, __int64, __int64))(v26 + 208))(v26, v14 + v9, v13, v27);
    v17 = *((_DWORD *)ptr + 20);
    if ( v17 <= v4 )
      goto LABEL_39;
    v18 = *v10 + 1;
...
LABEL_43:
  ...
  v28 = ptr;
  v22 = sub_17800(13, (__int64 *)(v5 + 24), (void **)(v5 + 32), (__int64)&v28);
  v23 = v22;
  if ( v22 )
  {
    *((_DWORD *)v22 + 10) = 1;
