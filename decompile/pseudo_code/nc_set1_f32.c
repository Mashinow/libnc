...
// ======================================================
// Function: nc_set1_f32 @ 0x66A17200
// ======================================================

// local variable allocation has failed, the output may be wrong!
__int64 __fastcall nc_set1_f32(__int64 a1, int a2, _QWORD *a3, double _XMM3_8)
{
  __int64 v4; // rdi
  __int64 v5; // rax
  __int64 v10; // r9
  ...
  if ( (_DWORD)v5 )
  {
    ...
    LOWORD(v13[0]) = (unsigned int)(_ECX + (HIWORD(_R8D) & 1) + 0x7FFF) >> 16;
  }
  else
  {
    __asm { vmovss  [rsp+48h+var_28], xmm3 }
  }
  if ( *(_DWORD *)(a1 + 80) != a2 )
  {
  ...
  else
  {
    ...
    if ( a2 != 1 )
    {
      v11 += a3[1] * *(_QWORD *)(a1 + 96);
      if ( a2 != 2 )
      {
        v11 += a3[2] * *(_QWORD *)(a1 + 104);
        if ( a2 != 3 )
          v11 += *(_QWORD *)(a1 + 112) * a3[3];
      }
    }
  }
  return (*(__int64 (__fastcall **)(__int64, __int64, int *, __int64))(v4 + 88))(
           v4,
           *(_QWORD *)(a1 + 56) + v11,
           v13,
           v10);
