...
// ======================================================
// Function: nc_get1_f32 @ 0x66A1A110
// ======================================================

__m128 __fastcall nc_get1_f32(__int64 a1, int a2, _QWORD *a3)
{
  __int64 v3; // rdi
  int v6; // edx
  void (__fastcall *v7)(__int64, int *, __int64, __int64); // r10
  __int64 v8; // r8
  __int64 v9; // rax
  __m128 result; // xmm0
  int v11[7]; // [rsp+2Ch] [rbp-1Ch] BYREF
  ...
  if ( *(_DWORD *)(a1 + 48) )
  {
    ...
    v6 = *(_DWORD *)(a1 + 80);
    v7 = *(void (__fastcall **)(__int64, int *, __int64, __int64))(v3 + 96);
    v8 = *(_QWORD *)(a1 + 56);
    if ( v6 > 0 )
      goto LABEL_5;
LABEL_11:
