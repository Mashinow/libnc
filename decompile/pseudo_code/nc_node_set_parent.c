...
// ======================================================
// Function: nc_node_set_parent @ 0x66A19AC0
// ======================================================

void __fastcall nc_node_set_parent(__int64 a1, int a2, __int64 a3)
{
  __int64 v3; // rbx
  _QWORD *v6; // rsi
  ...
  if ( a2 < 0 || a2 >= *(_DWORD *)(a1 + 24) )
    sub_66A33D40("arg_index >= 0 && arg_index < n->n_parents", "libnc.c", 5300);
  nc_free_node(*(__int64 **)(*(_QWORD *)(a1 + 32) + 8 * v3));
