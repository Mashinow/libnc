...
// ======================================================
// Function: nc_sgd_opt_end @ 0x66A31EB0
// ======================================================

void __fastcall nc_sgd_opt_end(__int64 a1)
{
  if ( *(_QWORD *)(a1 + 16) != a1 + 8 )
    sub_66A33D40("list_empty(&s->var_list)", "libnc.c", 9444);
  (*(void (__fastcall **)(_QWORD))(a1 + 56))(*(_QWORD *)(a1 + 24));
