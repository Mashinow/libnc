...
// ======================================================
// Function: nc_node_set_arg @ 0x66A19B20
// ======================================================

void __fastcall nc_node_set_arg(__int64 a1, int a2, __int64 a3)
{
  __int64 v3; // rbx
  _QWORD *v6; // rsi
  ...
  if ( a2 < 0 || a2 >= *(_DWORD *)(a1 + 40) )
    sub_66A33D40("arg_index >= 0 && arg_index < n->n_args", "libnc.c", 5307);
  nc_free_tensor(*(_DWORD **)(*(_QWORD *)(a1 + 48) + 8 * v3));
  v6 = (_QWORD *)(*(_QWORD *)(a1 + 48) + 8 * v3);
  ++*(_DWORD *)(a3 + 16);
  *v6 = a3;
}
