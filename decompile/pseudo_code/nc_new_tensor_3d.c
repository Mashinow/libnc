...
// Root function: nc_new_tensor_3d
// Included functions: 3

// ======================================================
// Function: nc_new_tensor_3d @ 0x66A14FF0
// ======================================================

_QWORD *__fastcall nc_new_tensor_3d(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r13
  _QWORD *v10; // rbx
  __int64 v11; // rdi
  ...
  *v10 = v20;
  v10[1] = v5 + 16;
  *(_QWORD *)(v5 + 16) = v10;
  (*(void (__fastcall **)(__int64, _QWORD, _QWORD, __int64, _DWORD))(a1 + 104))(a1, v10[7], 0i64, v15, 0);
  return v10;
}
