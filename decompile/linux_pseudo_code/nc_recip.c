...
// Root function: nc_recip
// Included functions: 2

// ======================================================
// Function: nc_recip @ 0x1E920
// ======================================================

__int64 __fastcall nc_recip(_QWORD *ptr)
{
  __int64 v2; // rsi
  __int64 v3; // rax
  int v4; // ebp
  ...
  _QWORD *v23; // rbx
  _QWORD *v24; // rax
  __int64 v26; // [rsp+0h] [rbp-78h]
  __int64 v27; // [rsp+8h] [rbp-70h]
  _QWORD *v28; // [rsp+18h] [rbp-60h] BYREF
  ...
  v26 = *(_QWORD *)(ptr[5] + 24LL);
  if ( (_DWORD)v2 )
    nc_error("unsupported type for %s\n", (char)"nc_recip");
  v3 = nc_new_tensor_nz(v26, v2, *((unsigned int *)ptr + 20), ptr + 15);
  v4 = *(_DWORD *)(v3 + 80);
  v5 = v3;
...
LABEL_45:
    ...
    (*(void (__fastcall **)(__int64, __int64, __int64, __int64))(v26 + 200))(v26, v14 + v9, v13, v27);
    v17 = *((_DWORD *)ptr + 20);
    if ( v17 <= v4 )
      goto LABEL_39;
    v18 = *v10 + 1;
    *v10 = v18;
    if ( v18 == ptr[v4 + 15] )
    {
      ...
      while ( 1 )
      {
        ...
        v21 = v10[v19 + 1] + 1;
        v10[++v19] = v21;
        if ( v21 != ptr[(unsigned int)(v4 + 1) + 14 + v19] )
          goto LABEL_43;
      }
LABEL_39:
      v29 = -1LL;
...
LABEL_43:
  ...
  v28 = ptr;
  v22 = sub_17800(12, (__int64 *)(v5 + 24), (void **)(v5 + 32), (__int64)&v28);
  v23 = v22;
  if ( v22 )
  {
    *((_DWORD *)v22 + 10) = 1;
    v24 = (_QWORD *)nc_malloc(8uLL);
    v23[6] = v24;
    *v24 = nc_dup_tensor(ptr);
  }
  nc_free_tensor(ptr);
  return v5;
}
