...
// Root function: nc_min
// Included functions: 3

// ======================================================
// Function: nc_min @ 0x1EFE0
// ======================================================

__int64 __fastcall nc_min(_QWORD *ptr, _QWORD *a2)
{
  __int64 v4; // rsi
  __int64 v5; // rdx
  __int64 v6; // rax
...
LABEL_6:
    sub_18270("min", (__int64)ptr, (__int64)a2);
  if ( (int)v5 > 0 )
  {
    if ( a2[15] != ptr[15] )
      goto LABEL_6;
...
LABEL_69:
    v32 = v15;
    (*(void (__fastcall **)(__int64, __int64, char *, __int64, __int64, __int64))(v34 + 312))(
      v34,
      v21,
      v25,
      v22,
